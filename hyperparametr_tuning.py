...
def objective(trial):
    ...
    val_loss = train_model(model, train_loader, val_loader, num_epochs=args.epochs, learning_rate=args.learning_rate, scheduler_type="StepLR", early_stopping_patience=args.early_stopping_patience)
